...
const Home = () => {
    return (
        <main>
            ...
            <h2>This Game</h2>
            <p>Welcome to Guildsmen! A steampunk, fantasy-esque, pen and paper, table-top roleplaying game. Here, you will
                create a character and interact with the fantastic world of Thelius. This game is a “theater of the mind”
                experience where one player (known as the Game Master) will create an adventure that the other players will play through as if they are the protagonists in the story. All you’ll need to play this game is this book, some  pencils, some character sheets, and some 6-sided dice.</p>

            <p><em>If you’ve never played a table-top roleplay game before, you’re in for a treat! </em></p>

            <p>A table-top roleplay game (TTRPG) is an interactive adventure that is guided by you and those you play with. But instead of. Every player in the group helps narrate the story and make the decisions of the main characters.
            </p>
            ...
            <p>This is a story that you are writing with each of the other players. The end is not set, and your actions
                determine everything in this world – and you can do anything! Be it start a business, invent the bicycle, kill a dragon, overthrow the government, or explore the wilderness.</p>
