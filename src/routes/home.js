...
const Home = () => {
    return (
        <main>
            ...
            <p>A table-top roleplay game (TTRPG) is an interactive adventure that is guided by you and those you play with. Every player in the group helps narrate the story and make the decisions of the main characters.</p>
            ...
            <p>This is a story that you are writing with each of the other players. The end is not set, and your actions determine everything in this world – and you can do anything! Be it start a business, invent the bicycle, kill a dragon, overthrow the government, or explore the wilderness.</p>
