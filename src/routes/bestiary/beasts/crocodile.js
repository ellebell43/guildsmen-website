  ...
  return (
    <main>
      <div className="creatureBlock">
        <h1 className="title">Crocodile (Deadly, +0)</h1>

        <div className="stats">
          <p>Tough +8 | Nimble +7</p>
        ...
        <div className="actions">
          ...
          <p><strong>Chomp</strong> (+6) – The Crocodile chomps down with its jaws that are powerful enough to crush a person’s body.</p>

          <p><strong>Drowning Drag</strong> – The Crocodile grabs you and drags you into the water. It grapples you via an opposed Tough check. If the crocodile succeeds, then you take 4 Harm and are then dragged into the water to cause 1 Harm (ignoring armor) for every round that you are held under the water.
          </p>
        </div>
      </div>
