  ...
  return (
    <main>
      <div className="creatureBlock">
        ...
        <p className="creatureDescription">Police Officers take their duty seriously. They protect the citizens and do their best to keep ruffians and thugs off the streets and maintain the peace. However, a few have been known to turn a blind eye for the right price…</p>
