...
const Myth = () => {
    return (
        <main>
            ...
            <h2>Myth Quality</h2>
            <p>Each vial of Myth gives you a number of uses to cast spells, depending on its quality. </p>
            ...
            <p><strong><em>Whenever you successfully use Myth to manipulate an element, you will become more addicted to the Myth. On a successful use, you must fill in 2 bars on the addiction meter on your character sheet.</em></strong></p>
