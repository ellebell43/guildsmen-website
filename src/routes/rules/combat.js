...
const Combat = () => {
    return (
        <main>
            ...
            <p>Some conditions, such as the <strong><em>Burning</em></strong> condition will usually be ongoing. That means that the condition continues to affect your character until something specific happens (in the case of <strong><em>Burning</em></strong>, you must put out the fire to end the effect).</p>
