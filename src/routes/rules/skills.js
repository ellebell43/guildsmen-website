    ...
    return (
        <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className='bottom right alignRight'>6+</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Moderate</td>
                        <td className='bottom right alignRight'>8+</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Difficult</td>
                        <td className='bottom right alignRight'>10+</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Very Difficult</td>
                        <td className='bottom right alignRight'>12+</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td className='bottom left alignLeft'>Extreme Fail</td>
                        <td className='bottom right alignRight'>-4</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Fail</td>
                        <td className='bottom right alignRight'>-2</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Mixed Success</td>
                        <td className='bottom right alignRight'>-1</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Success</td>
                        <td className='bottom right alignRight'>0</td>
                    </tr>
                    <tr>
                        <td className='bottom left alignLeft'>Extreme Success</td>
                        <td className='bottom right alignRight'>+4</td>
                    </tr>
                </tbody>
            </table>
            ...
            <p><strong>Types</strong> – In the <Link onClick={toTop} to="/rules/myth"><em>Myth chapter</em></Link>, the various types of Myth are outlined. You can specialize in any of those types.</p>
