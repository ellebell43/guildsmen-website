const Skills = () => {
    return (
        <div>
            ...
            <p><strong>Lead</strong> is your ability to guide groups or establishments and be a figure of authority. It is used primarily in Establishments (see the <em>Establishments</em> chapter), but can also be used to be an authority to NPCs (non-player characters)</p>

            <p><strong>Medic</strong> is your ability to heal and care for injured creatures. This is used to restore Harm and remove combat conditions (see the <em>Combat</em> chapter). </p>

            <p><strong>Myth</strong> is your ability to use and control the powers that come from Myth, an addictive drug refined from the blood of magical creatures.</p>
            ...
            <p><strong>Skills Checks</strong> are how you apply your skills in- game. You first determine which skill category applies to the action you want to do. For example, if you wanted to hide from some thugs that are chasing you, that action would fall under the sneaky skill category.</p>
            ...
            <p className='tableTitle'>Task Difficulty</p>
            <div className='twoColumnTable table taskDifficultyTable'>
                <div className='col1'>
                    <p className='colItem'>Very Easy</p>
                    <p className='colItem'>Easy</p>
                    <p className='colItem'>Average</p>
                    <p className='colItem'>Difficult</p>
                    <p className='colItem'>Very Difficult</p>
                </div>
                <div className='col2'>
                    <p className='colItem'>4+</p>
                    <p className='colItem'>6+</p>
                    <p className='colItem'>8+</p>
                    <p className='colItem'>10+</p>
                    <p className='colItem'>12+</p>
                </div>
            </div>
            ...
            <p className='tableTitle'>Degrees of Success</p>
            <div className='twoColumnTable table successDegreeTable'>
                <div className='col1'>
                    <p className='colItem'>Extreme Fail</p>
                    <p className='colItem'>Fail</p>
                    <p className='colItem'>Mixed Success</p>
                    <p className='colItem'>Success</p>
                    <p className='colItem'>Extreme Success</p>
                </div>
                <div className='col2'>
                    <p className='colItem'>-4</p>
                    <p className='colItem'>-2</p>
                    <p className='colItem'>-1</p>
                    <p className='colItem'>0</p>
                    <p className='colItem'>+4</p>
                </div>
            </div>
            ...
            <p>Normally, you would simply be able to notice any common clues, such as footprints. However, the goal was to roll an 8, but you managed to roll a 13. The Game Master decided to take Degree of Success into account: 13-8=5. The difference between the rolled number and the goal is 5, making this an Extreme Success.</p>

            <p>So, instead of just simply noticing footprints, maybe the Game Master will also let you know that there is a bystander that might know something or gives you additional information on what you are trying to track that you wouldn’t have gotten otherwise.</p>

            <p><em>The Game Master doesn’t have to use degrees of success, it’s completely optional.</em></p>
            ...
            <h3>Experience</h3>
            <p>Experience is used to increase skills and stats and it is earned whenever you successfully roll a dice check. Whenever a dice check is successful, you fill in a bubble in the experience box. Once you fill up all of the bubbles (4 successful skill checks) you gain 1 experience point.</p>
            ...
            <p><strong>Metal</strong> – you specialize in crafting items using metal as the primary material. This generally means the use of a forge and smithy.</p>
            ...
            <h4>Investigate Specialties</h4>
            <p><strong>Awareness</strong> – you specialize in investigation by passive observation. You are more aware of your surrounding than ithers and you take in information that is given by the environment you’re in.</p>
            ...
            <p><strong>Beasts</strong> – You specialize in healing beasts. You are a veterinarian and know how to heal creatures rather than people.</p>
            ...
            <p><strong>Types</strong> – In the <em>Myth</em> chapter, the various types of Myth are outlined. You can specialize in any of those types.</p>

            <h4>Nature Specialties</h4>
            ...
            <p><strong>Ranged</strong> – You specialize in ranged combat. You are skilled in long-distance weapons such as bows and crossbows.</p>
        </div>
    )
}
