const Combat = () => {
    return (
        <div>
            <h2>Combat</h2>
            <p>As you play, you may find yourself in a situation where you need to fight someone or something. When this happens, we strongly suggest you find ways of fighting other than going head on swinging a sword. Combat in Guildsmen is designed to be fast and deadly. An unprepared adventurer will die very, very quickly. Think outside the box and find other ways to handle tense situations other than bludgeoning your opponent to death. Also make sure to cooperate with your party. A player who goes off alone is much more likely to die.</p>

            <h3>Avoiding Combat</h3>
            ...
            <p>You can also try to calm down or persuade the other party to avoid the fight. If you’ve angered an opponent to the point of violence, the social skill can come in very handy for talking them down.</p>

            <p>Another option is to make your opponent feel like they can’t win, even if they totally could. This is another situation where the social skill comes in handy. Any items you have at your disposal to display a false amount of power could also be helpful in demoralizing your opponent.</p>

            <p>A last resort would be to simply run and hide. If you’re worried about getting hurt or killed, it’s best to flee the situation instead trying to come out on top.</p>

            <p>Now that you know how to <em>avoid</em> combat, this is what you do when you <em>don’t</em> avoid combat:</p>
            ...
            <p>At times, certain players or creatures will go into combat with some sort of advantage such as being hidden from their enemy, attacking suddenly and without warning, or other scenarios that gives a player the upper hand at the beginning of combat.</p>
            ...
            <p>The goal of combat is to deal Harm to your enemy until they either run away, fall unconscious, or die. Harm is caused by creating bodily harm to your enemy by performing actions.</p>
            ...
            <p>You can also react as a group. When reacting as a group, you must be able to justify how the group is react as one entity. For example, if a player was being attacked by a bear, the player being directly attacked could try to dodge and another player nearby could try to pull the other out of the way.</p>
            ...
            <h3>Dealing Harm</h3>
            <p>When you successfully attack another creature, you will deal harm. The harm you deal is <strong>equal to the difference between the dice rolls plus the bonus of your weapon</strong>. If the victim rolls the higher number, then the attack deals no damage.</p>

            <p><em>For example</em>: you have +2 <em>throwdown</em>, and you attack a bandit that has +1 Nimble with a light weapon. You roll a 9 and add 2 for your modifier in the skill you used, giving you a total of 11. The bandit rolls to run away with an 8 and adds 1 for their Nimble modifier, giving them a total of 9. You have the higher number, so your attack is successful! The difference between your roll and the bandit’s roll is 2 and the bonus of a light weapon is 1, which means that you deal 3 Harm in total to the bandit.</p>
            ...
            <p>The amount of Harm you can take is represented by a set of 7 bubbles below your stats. If all 7 bubbles get filled in, then you die. If you fill in any red bubbles, then you are dying. When this happens, you will begin to take harm periodically, at the Game Master's discretion, until you die, unless you find a way to recover from your harm. Getting to the point of dying may also cause you to fall unconscious.</p>
            ...
            <h3>Recovering from Harm</h3>
            <p>Recovering from harm can only be done through another character’s <em>medic</em> skill check or by using a consumable item (see the <em>Market</em> chapter). When using a <em>medic</em> check, a roll of 10 or more will let the wounded person recover from 2 points of Harm. This can only be done outside of combat.</p>

            <h3>Weapons</h3>
            <p>All weapons have a bonus that is added to your roll when an attack is successful. There are 2 types of weapons, Heavy and Light. Light weapons give a +1 bonus and heavy weapons give a +2 bonus. However, <strong>heavy weapons require a Tough stat of +2 or more</strong> in order for you to use them.</p>

            <p>If you are <em className='underline'><strong>using a bow</strong></em>, you have disadvantage to attack when at close range, but get twice the bonus (+2 for a light bow, +4 for a heavy bow). If you are <em className='underline'><strong>using a gun</strong></em>, you have disadvantage at long range and always have triple the normal bonus (+3 for light guns, +6 for heavy guns).</p>
            ...
            <h3>Skill Shots</h3>
            <p>If you want to attack a creature in a very specific way (i.e., putting a dagger through their eye), then you may roll a difficult to very difficult skill check. If you are successful, then the Game Master will give a special outcome (such as your enemy dying immediately). When this happens, you will struggle alone, meaning you cannot get any help from an ally. Skill shots are not opposed, but if you fail the roll, your opponent gets to roll. If they roll higher than you did, then they can cause Harm to you and your allies cannot help to deflect it, so be careful. </p>
