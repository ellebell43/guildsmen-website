  ...
  return (
    <article>
      ...
      <section>
        ...
        <p>The Fictus Arboreus, commonly known as a Hunting Tree, is the only known Starborne plant. Unlike Starborne animals, it has no inherent magical abilities due to its fundamentally different physiology and lack of need for a magical defensive system. The Star Gem is located beneath the main trunk of the plant in a thick cocoon of roots. The Crystal is used to provide its energy instead of photosynthesis, while it eats other creatures to provide itself with materials for growth and reproduction.</p>

        <p>This plant-based Starborne creature is carnivorous. Its main body is wide and goblet shaped with a cap on top, and at first glance appears to have no other appendages attached to it. However, the main purpose of this plant's root system is not to absorb nutrients from the ground, but to hide its very motile arms. Spreading out from the Star Gem root-cocoon is a great many vines that travel under the ground. When they encounter a larger root system from an actual tree, some of these vines then grow upward, acting much like creeper vines as they wrap around the other plant. These particular vines are known as sentinels. They are the eyes of the tree. Each vine has at least one organ that seems to be able to see heat. The Hunting Tree uses this to find its prey.</p>
        ...
        {/* ⦁	It’s a carnivorous jungle plant with creeper vine-like tentacles coming up from the root system
            ...
            ⦁	The Star Gem is contained beneath the plant, wrapped in a thick cocoon of roots
            ...
            ⦁	Could potentially be used to “garden” Star Gems
