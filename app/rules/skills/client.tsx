...
export function DegreesOfSuccessTable(props: { small?: boolean }) {
  const style = props.small ? "text-xs m-0" : ""

  return (
    <table>
      <thead>
        <tr>
          <th className={style} colSpan={2}>Degree of Success</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className={`bottom left text-left ${style}`}>Extreme Fail</td>
          <td className={`bottom right text-right ${style}`}>-4</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Fail</td>
          <td className={`bottom right text-right ${style}`}>-2</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Mixed Success</td>
          <td className={`bottom right text-right ${style}`}>-1</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Success</td>
          <td className={`bottom right text-right ${style}`}>0</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Extreme Success</td>
          <td className={`bottom right text-right ${style}`}>+4</td>
        </tr>
      </tbody>
    </table>
...
export function TaskDifficultyTable(props: { small?: boolean }) {
  const style = props.small ? "text-xs m-0" : ""
  return (
    <table>
      <thead>
        <tr>
          <th className={style} colSpan={2}>Task Difficulty</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className={`bottom left text-left ${style}`}>Very Easy</td>
          <td className={`bottom right text-right ${style}`}>4+</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Easy</td>
          <td className={`bottom right text-right ${style}`}>6+</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Moderate</td>
          <td className={`bottom right text-right ${style}`}>8+</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Difficult</td>
          <td className={`bottom right text-right ${style}`}>10+</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Very Difficult</td>
          <td className={`bottom right text-right ${style}`}>12+</td>
        </tr>
        <tr>
          <td className={`bottom left text-left ${style}`}>Super Difficult</td>
          <td className={`bottom right text-right ${style}`}>14+</td>
        </tr>
      </tbody>
    </table>
  )
