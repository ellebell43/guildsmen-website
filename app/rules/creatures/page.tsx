  ...
  return (
    <article>
      ...
      <section id="types-of-creatures">
        ...
        <p>In the world of Guildsmen, there are three types of creatures: people, beasts, and Starborne. The first two are pretty obvious. People are non-player characters that are one of the playable species, and beasts are animals that are common to this world like bears and wolves. Starborne creatures, however, are integral to the lore of the world since they are the only source of Star Gems.</p>

        <p>The only thing that distinguishes a Starborne creature from any other kind is that they carry a Star Gem of some size within their body. Generally, these creatures are hunted to procure those crystals, but doing that is very dangerous. As outlined in the <Link href="/rules/invention#star-gem">Invention chapter</Link>, Star Gems break as easily as glass jars and, when they do break, they explode violently. So, when battling a Starborne creature, it is crucial to keep this concept in mind. If you strike to hard in the wrong place, the creature will explode and die, possibly taking you with it.</p>

        <p>It&apos;s also good to know that Starborne creatures will usually have the power to manipulate one element or another. For example, a phoenix will have the ability to manipulate fire, and since their body is always on fire, they have a large source to pull from to send blasts of fire out. The Abominable Ram has power over water and use it to manipulate the snow that permeates their natural habitat. So, when hunting or encountering a Starborne creature, be cautious and keep in mind that they do have extraordinary powers.</p>

        <p>With that said, all creatures generally fight to preserve their own life and Starborne creatures usually aren&apos;t incredibly creative with their powers. While Starborne creatures are generally much more aggressive than beasts and people, their first priority will be to keep their self alive. So, the Abominable Ram might use their powers to whip up a small blizzard to obscure it while it runs away rather than doing something more damaging and aggressive.</p>

        <p>So, tip for the Game Masters: people, beasts, and Starborne creatures are primarily focused on survival. While Starborne animals are very aggressive compared to the other types of creatures, they will not fight to the death if they can help it. Once things are looking more dicey for them, they will probably try to run.</p>
      </section>
